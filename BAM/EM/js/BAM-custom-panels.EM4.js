...
var aboutBoxHtml = '<div id="infoBox" class="nonMapOverlay"> <b> Application Information </b>';
    ...
    aboutBoxHtml = aboutBoxHtml + '<div id="infoBoxContent">';
     ...
     aboutBoxHtml = aboutBoxHtml + '<br/>Paul Dilley is the PI of the Global Manuscript Cultures site.  The software is based on the basic architecture established by Ryan Horne for the Big Ancient Mediterranean project, which has been extensively developed by Ed Keogh.  Data analysis has been conducted by Paul Dilley and Melissa Moreton.  In the future, manuscript entries based on research papers by University of Iowa undergraduates in Paul Dilley’s Judaism, Christianity, and Islam class will be entered, and credited in their respective entries. '
