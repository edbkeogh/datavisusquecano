...
!function(e, t) {
    ...
    function w(e, t) {
        ...
        function x(l) {
            ...
            F = F.merge(z.append("text").attr("fill", "currentColor").attr(u, o * x).attr("dy", e === d ? "0em" : e === b ? "0.71em" : "0.32em")),
    ...
    var Dt, Ct, zt, Nt = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Ft(e) {
    ...
    t(function(e) {
      ...
      , ai = r({
        ...
        update: function(e) {
            ...
            a.append("rect").attr("y", 0).attr("rx", 0).attr("ry", 0).attr("stroke-width", 0),
            a.append("text").style("text-anchor", "middle").style("dominant-baseline", "central"),
            a.append("title"),
    ...
    return r({
        ...
        update: function(t) {
            ...
            function(e) {
                ...
                var a = n.enter().append("rect").attr("class", "series-segment").attr("rx", 1).attr("ry", 1).attr("x", t.graphW / 2).attr("y", t.graphH / 2).attr("width", 0).attr("height", 0).style("fill", "red").style("fill-opacity", 0).on("mouseover.groupTooltip", t.groupTooltip.show).on("mouseout.groupTooltip", t.groupTooltip.hide).on("mouseover.lineTooltip", t.lineTooltip.show).on("mouseout.lineTooltip", t.lineTooltip.hide).on("mouseover.segmentTooltip", t.segmentTooltip.show).on("mouseout.segmentTooltip", t.segmentTooltip.hide);
