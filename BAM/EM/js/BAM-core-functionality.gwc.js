    ...
    if (toggle == false && informationToggle2 == false) {
        $('#' + pane).animate({
          left: newwidth +"px",
            ...
            // Animation complete.
            $('#' + button).html('&#9664;<b><br/><br/><br/><br/><br/><br/><br/>O<br/>b<br/>j<br/>e<br/>c<br/>t<br/><br/>M<br/>e<br/>t<br/>a<br/>d<br/>a<br/>t<br/>a<div id="btn-bottom" style="position:absolute;bottom:15px;">&#9664;</div>');
        });
        toggle = true;
...
// &#9650;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>M a n u s c r i p t&nbsp;&nbsp;&nbsp;R e s u l t s&nbsp;&nbsp;T a b l e</b><span id="resultTableBRC" style="position:absolute;right:20px;">&#9650;</span>
        ...
        $("#right-side-panel").animate({
          ...
          $("#right-btn-slide-toggle").html('&#9664;<b><br/><br/><br/><br/><br/><br/><br/>O<br/>b<br/>j<br/>e<br/>c<br/>t<br/><br/>M<br/>e<br/>t<br/>a<br/>d<br/>a<br/>t<br/>a<div id="btn-bottom" style="position:absolute;bottom:15px;">&#9664;</div>');
    if (informationToggle == false) {$("#right-btn-slide-toggle").html('&#9654;<b><br/><br/><br/><br/><br/><br/><br/>O<br/>b<br/>j<br/>e<br/>c<br/>t<br/><br/>M<br/>e<br/>t<br/>a<br/>d<br/>a<br/>t<br/>a<div id="btn-bottom" style="position:absolute;bottom:15px;">&#9654;</div>');};
        });
        toggle = false;
    }
    return toggle;
