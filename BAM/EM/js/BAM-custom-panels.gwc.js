...
var databaseBoxHtml = '<div id="databaseBox" > <div id="databaseBoxTop"> <br/><br/>';
...
function search() {
  ...
  if (document.getElementById('manuscriptName-search').value) {
    ...
    if (document.getElementById('content-search').value) {
      data['content'] = document.getElementById('content-search').value;
      }
  // if (document.getElementById('significance-search').value) {
  //       data['significance'] = document.getElementById('significance-search').value;
  //       }
...
console.log(results);
		paramTypes.forEach(function(paramType) {
			...
			for (let index in results[paramType]) {
                ...
                // console.log(val);
				// document.getElementById('selected_' + paramType).innerHTML += '<li id="i'+ paramType + '_' + val + '">' + val + ' <button id="b' + paramType + '_' + val + '" class="remove-button" onclick="removeParam(\'' + paramType + '\', \'' + val + '\')"><u>remove</u></button></li>';
//document.getElementById('selected_' + paramType).innerHTML += '<li id="i'+ paramType + '_' + val + '">' + val + ' <button id="b' + paramType + '_' + val + '" class="remove-button" onclick="removeParam(\'' + paramType + '\', \'' + val + '\')"><u>add</u></button></li>';
//TODO add the params to the suggestion dropdown
document.getElementById('dropdown_' + paramType).innerHTML += '<option>' + val + '</option>';
			}
			// if (menu.innerHTML === '') menu.innerHTML = `<option>N/A</option>`;
		});
