...
//this part below changes the brush ranges
...
function timelineSingle(domElement) {
// document.getElementById("interval").style.opacity = .5;
    //--------------------------------------------------------------------------
    //
    // chart
    //
...
// console.log(result);
    ...
    timeline.band = function (bandName, sizeFactor) {
        ...
        var items = band.g.selectAll("g")
            .data(data.items)
            .enter().append("svg")
            // .attr("y", function (d) { return band.yScale(d.track); }) //that y error
            .attr("height", band.itemHeight)
...
//this part below changes the brush ranges
        ...
        intervals.append("text")
            ...
            .attr("x", 1)
            .attr("y", 10)
//            .text(function (d) { return d.label; }); // changed into a marker
            .text("|");
