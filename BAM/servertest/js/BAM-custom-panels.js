...
contributorsBoxHtml = contributorsBoxHtml + '<p>CANT&nbsp;=&nbsp;Clavis Apocryphorum Novi Testamenti<span class="tab">Classical&nbsp;=&nbsp;<br/>' //<a href=\"http://www.perseus.tufts.edu/\" target=\"_blank\">Perseus Digital Library</a></span><br/>';
contributorsBoxHtml = contributorsBoxHtml + 'CGL&nbsp;=&nbsp;Corpus Grammaticorum Latinorum<span class="tab">Late Antique/Non-Christian&nbsp;=&nbsp;<br/>' //<a href=\"http://digiliblt.lett.unipmn.it\" target=\"_blank\">digilibLT</a></span><br/>';
contributorsBoxHtml = contributorsBoxHtml + 'CPL&nbsp;=&nbsp;Clavis Patrum Latinorum<span class="tab">Late Antique/Christian&nbsp;=&nbsp;<br/>' //<a href=\"http://www.mlat.uzh.ch/MLS/xanfang.php?corpus=2\" target=\"_blank\">Corpus Corporum (Patrologia Latina)</a></span><br/>';
contributorsBoxHtml = contributorsBoxHtml + 'DLT&nbsp;=&nbsp;digilibLT<br/>' //<a href=\"http://digiliblt.lett.unipmn.it\" target=\"_blank\">digilibLT</a><span class="tab">Grammarians&nbsp;=&nbsp;<br/>' //<a href=\"http://www.mlat.uzh.ch/MLS/xanfang.php?corpus=13\" target=\"_blank\">Corpus Grammaticorum Latinorum</a></span><br/>';
contributorsBoxHtml = contributorsBoxHtml + 'DPA&nbsp;=&nbsp;Dictionnaire des philosophes antiques<span class="tab">Tokenization and lemmatization are achieved through programs from the Classical Language Toolkit<br/>' //<b><a href=\"http://cltk.org/\" target=\"_blank\">Classical Language Toolkit</a></b></span><br/>';
contributorsBoxHtml = contributorsBoxHtml + 'FRH&nbsp;=&nbsp;Fragments of the Roman Historians<br/>';
contributorsBoxHtml = contributorsBoxHtml + 'P&nbsp;=&nbsp;Packard Humanities Institute (via Perseus Catalog)<br/>' //<a href=\"http://catalog.perseus.org/\" target=\"_blank\">Perseus Catalog</a>)<br/>';
contributorsBoxHtml = contributorsBoxHtml + 'PL&nbsp;=&nbsp;Patrologia Latina<br/>';
contributorsBoxHtml = contributorsBoxHtml + 'Stoa&nbsp;=&nbsp;Stoa Consortium (via Perseus Catalog)<br/>' //<a href=\"http://catalog.perseus.org/\" target=\"_blank\">Perseus Catalog</a>)</p>';
